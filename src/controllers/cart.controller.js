//Controller: Operaciones del negocio. El controlador se conecta con el service. Gestiona las peticiones del cliente(navegador web) y las respuestas del servidor(App), toma parametros, datos del body...
